...
namespace gazebo
{
  class TurnOnLightPlugin : public WorldPlugin
  {
    ...
    {
      gzmsg << "Loading mast lights plugin\n";
    ...
    {
      msgs::Light redLightMsg;
      msgs::Light greenLightMsg;
      redLightMsg.set_name("mast::body::redLight");
      greenLightMsg.set_name("mast::body::greenLight");
      ...
      else
      {
        ...
        redLightMsg.set_range(0.0);
        greenLightMsg.set_range(0.0);
      }
      this->lightPub->Publish(redLightMsg);
      this->lightPub->Publish(greenLightMsg);
    }
